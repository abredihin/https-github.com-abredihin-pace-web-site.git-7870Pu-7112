...
const translations = {
  en: {
    ...
    mvpNote: "If you organize races and want your events in Pace, we'd love to talk. Use the form below to get in touch",
  ...
  ptbr: {
    ...
    mvpNote: "Se você organiza provas e quer seus eventos no Pace, adoraríamos conversar. Use o formulário abaixo para entrar em contato",
